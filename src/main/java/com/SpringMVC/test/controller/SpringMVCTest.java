...
/**
 * 
 * @author liu.hb 类定义处标记的@RequestMapping 限定了处理器类可以处理所有 URI 为 /SpringMVC 的请求，它相对于
 *         WEB 容器部署的根路径
 */
...
public class SpringMVCTest {
	...
	/**
	 * @RequestMapping 的 value、method、params 及 heads 分别表示请求
	 *                 URL、请求方法、请求参数及请求头的映射条件
	 * @return 返回值会通过视图解析器解析为实际的物理视图,/WEB-INF/views/loginSuccess.jsp ,headers =
	 *         { "ContentType=text/*" }
	 */
	 ...
	 * @param username
	 * @param age
	 * @return required：是否必须。默认为 true, 表示请求参数中必须包含对应的参数，若不存在，将抛出异常
	 */
